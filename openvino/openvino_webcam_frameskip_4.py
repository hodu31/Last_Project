...
model1 = load_model('C:/Last_Project/사람관절추적모델/models/smoke.h5')
...
### 웹캠에 표시하는 부분
    def pd_render(self, frame, bodies):
        ...
        for body in bodies:
            ...
            # 모델 돌리기
            if len(self.temp_array_dict[body.track_id]) >= 200 and self.frame_counter % 10 == 0:
                ...
                body.predicted_label = [np.argmax(pred) for pred in prediction]
