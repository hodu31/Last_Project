    ...
    def pd_render(self, frame, bodies):
        ...
        for body in bodies:
            ...
            if self.predicted_label is not None and body.track_id in self.predicted_label:
                ...
                cv2.putText(frame, "{} pred:{}".format(body.track_id , self.predicted_label[body.track_id]), text_position_1, cv2.FONT_HERSHEY_PLAIN, 3, color_box, 3)
                print(body.track_id, self.predicted_label)
